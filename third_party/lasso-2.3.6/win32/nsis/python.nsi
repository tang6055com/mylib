...
!define PRODUCT_NAME "Lasso 2.3.6"
...
OutFile "Lasso-2_3_6.win32-py2.4.exe"
...
Function .onInit
  ...
  IfErrors 0 +2
    Call NoPython24
  FileOpen $0 $SYSDIR\liblasso-3.dll r
  IfErrors 0 +2
    Call NoLasso
  FileClose $0
...
Section -Post
  ...
  WriteRegStr HKLM "SOFTWARE\Python\Lasso\2.4\2.3.6\InstallPath" "" "$INSTDIR"
SectionEnd
...
Function NoPython24
	...
	StrCmp $LANGUAGE ${LANG_FRENCH} 0 +2
		MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Vous semblez ne pas avoir Python 2.4 d'installé, êtes-vous sûr de vouloir continuer ?" IDYES +2
        Abort
...
Function NoLasso
	...
	StrCmp $LANGUAGE ${LANG_FRENCH} 0 +2
		MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Vous semblez ne pas avoir la bibliothèque C LASSO-3 d'installé, êtes-vous sûr de vouloir continuer ?" IDYES +2
        Abort
...
Section Uninstall
  ...
  DeleteRegKey HKLM "SOFTWARE\Python\Lasso\2.4\2.3.6"
