...
typedef struct _TScan__isset {
  _TScan__isset() : startRow(false), stopRow(false), timestamp(false), columns(false), caching(false), filterString(false), sortColumns(false) {}
  bool startRow :1;
  bool stopRow :1;
  bool timestamp :1;
  bool columns :1;
...
class TScan {
 public:
  ...
  TScan() : startRow(), stopRow(), timestamp(0), caching(0), filterString(), sortColumns(0) {
  }
