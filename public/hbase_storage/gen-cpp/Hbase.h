...
class HbaseConcurrentClient : virtual public HbaseIf {
 public:
  HbaseConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  HbaseConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
 ...
 public:
  ...
  void enableTable(const Bytes& tableName);
  int32_t send_enableTable(const Bytes& tableName);
  void recv_enableTable(const int32_t seqid);
  void disableTable(const Bytes& tableName);
  int32_t send_disableTable(const Bytes& tableName);
  void recv_disableTable(const int32_t seqid);
  bool isTableEnabled(const Bytes& tableName);
  int32_t send_isTableEnabled(const Bytes& tableName);
  bool recv_isTableEnabled(const int32_t seqid);
  void compact(const Bytes& tableNameOrRegionName);
  int32_t send_compact(const Bytes& tableNameOrRegionName);
  void recv_compact(const int32_t seqid);
  void majorCompact(const Bytes& tableNameOrRegionName);
  int32_t send_majorCompact(const Bytes& tableNameOrRegionName);
  void recv_majorCompact(const int32_t seqid);
  void getTableNames(std::vector<Text> & _return);
  int32_t send_getTableNames();
  void recv_getTableNames(std::vector<Text> & _return, const int32_t seqid);
  void getColumnDescriptors(std::map<Text, ColumnDescriptor> & _return, const Text& tableName);
  int32_t send_getColumnDescriptors(const Text& tableName);
  void recv_getColumnDescriptors(std::map<Text, ColumnDescriptor> & _return, const int32_t seqid);
  void getTableRegions(std::vector<TRegionInfo> & _return, const Text& tableName);
  int32_t send_getTableRegions(const Text& tableName);
  void recv_getTableRegions(std::vector<TRegionInfo> & _return, const int32_t seqid);
  void createTable(const Text& tableName, const std::vector<ColumnDescriptor> & columnFamilies);
  int32_t send_createTable(const Text& tableName, const std::vector<ColumnDescriptor> & columnFamilies);
  void recv_createTable(const int32_t seqid);
  void deleteTable(const Text& tableName);
  int32_t send_deleteTable(const Text& tableName);
  void recv_deleteTable(const int32_t seqid);
  void get(std::vector<TCell> & _return, const Text& tableName, const Text& row, const Text& column, const std::map<Text, Text> & attributes);
  int32_t send_get(const Text& tableName, const Text& row, const Text& column, const std::map<Text, Text> & attributes);
  void recv_get(std::vector<TCell> & _return, const int32_t seqid);
  void getVer(std::vector<TCell> & _return, const Text& tableName, const Text& row, const Text& column, const int32_t numVersions, const std::map<Text, Text> & attributes);
  int32_t send_getVer(const Text& tableName, const Text& row, const Text& column, const int32_t numVersions, const std::map<Text, Text> & attributes);
  void recv_getVer(std::vector<TCell> & _return, const int32_t seqid);
  void getVerTs(std::vector<TCell> & _return, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const int32_t numVersions, const std::map<Text, Text> & attributes);
  int32_t send_getVerTs(const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const int32_t numVersions, const std::map<Text, Text> & attributes);
  void recv_getVerTs(std::vector<TCell> & _return, const int32_t seqid);
  void getRow(std::vector<TRowResult> & _return, const Text& tableName, const Text& row, const std::map<Text, Text> & attributes);
  int32_t send_getRow(const Text& tableName, const Text& row, const std::map<Text, Text> & attributes);
  void recv_getRow(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRowWithColumns(std::vector<TRowResult> & _return, const Text& tableName, const Text& row, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  int32_t send_getRowWithColumns(const Text& tableName, const Text& row, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  void recv_getRowWithColumns(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRowTs(std::vector<TRowResult> & _return, const Text& tableName, const Text& row, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_getRowTs(const Text& tableName, const Text& row, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_getRowTs(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRowWithColumnsTs(std::vector<TRowResult> & _return, const Text& tableName, const Text& row, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_getRowWithColumnsTs(const Text& tableName, const Text& row, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_getRowWithColumnsTs(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRows(std::vector<TRowResult> & _return, const Text& tableName, const std::vector<Text> & rows, const std::map<Text, Text> & attributes);
  int32_t send_getRows(const Text& tableName, const std::vector<Text> & rows, const std::map<Text, Text> & attributes);
  void recv_getRows(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRowsWithColumns(std::vector<TRowResult> & _return, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  int32_t send_getRowsWithColumns(const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  void recv_getRowsWithColumns(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRowsTs(std::vector<TRowResult> & _return, const Text& tableName, const std::vector<Text> & rows, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_getRowsTs(const Text& tableName, const std::vector<Text> & rows, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_getRowsTs(std::vector<TRowResult> & _return, const int32_t seqid);
  void getRowsWithColumnsTs(std::vector<TRowResult> & _return, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_getRowsWithColumnsTs(const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_getRowsWithColumnsTs(std::vector<TRowResult> & _return, const int32_t seqid);
  void mutateRow(const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const std::map<Text, Text> & attributes);
  int32_t send_mutateRow(const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const std::map<Text, Text> & attributes);
  void recv_mutateRow(const int32_t seqid);
  void mutateRowTs(const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_mutateRowTs(const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_mutateRowTs(const int32_t seqid);
  void mutateRows(const Text& tableName, const std::vector<BatchMutation> & rowBatches, const std::map<Text, Text> & attributes);
  int32_t send_mutateRows(const Text& tableName, const std::vector<BatchMutation> & rowBatches, const std::map<Text, Text> & attributes);
  void recv_mutateRows(const int32_t seqid);
  void mutateRowsTs(const Text& tableName, const std::vector<BatchMutation> & rowBatches, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_mutateRowsTs(const Text& tableName, const std::vector<BatchMutation> & rowBatches, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_mutateRowsTs(const int32_t seqid);
  int64_t atomicIncrement(const Text& tableName, const Text& row, const Text& column, const int64_t value);
  int32_t send_atomicIncrement(const Text& tableName, const Text& row, const Text& column, const int64_t value);
  int64_t recv_atomicIncrement(const int32_t seqid);
  void deleteAll(const Text& tableName, const Text& row, const Text& column, const std::map<Text, Text> & attributes);
  int32_t send_deleteAll(const Text& tableName, const Text& row, const Text& column, const std::map<Text, Text> & attributes);
  void recv_deleteAll(const int32_t seqid);
  void deleteAllTs(const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_deleteAllTs(const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_deleteAllTs(const int32_t seqid);
  void deleteAllRow(const Text& tableName, const Text& row, const std::map<Text, Text> & attributes);
  int32_t send_deleteAllRow(const Text& tableName, const Text& row, const std::map<Text, Text> & attributes);
  void recv_deleteAllRow(const int32_t seqid);
  void increment(const TIncrement& increment);
  int32_t send_increment(const TIncrement& increment);
  void recv_increment(const int32_t seqid);
  void incrementRows(const std::vector<TIncrement> & increments);
  int32_t send_incrementRows(const std::vector<TIncrement> & increments);
  void recv_incrementRows(const int32_t seqid);
  void deleteAllRowTs(const Text& tableName, const Text& row, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_deleteAllRowTs(const Text& tableName, const Text& row, const int64_t timestamp, const std::map<Text, Text> & attributes);
  void recv_deleteAllRowTs(const int32_t seqid);
  ScannerID scannerOpenWithScan(const Text& tableName, const TScan& scan, const std::map<Text, Text> & attributes);
  int32_t send_scannerOpenWithScan(const Text& tableName, const TScan& scan, const std::map<Text, Text> & attributes);
  ScannerID recv_scannerOpenWithScan(const int32_t seqid);
  ScannerID scannerOpen(const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  int32_t send_scannerOpen(const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  ScannerID recv_scannerOpen(const int32_t seqid);
  ScannerID scannerOpenWithStop(const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  int32_t send_scannerOpenWithStop(const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  ScannerID recv_scannerOpenWithStop(const int32_t seqid);
  ScannerID scannerOpenWithPrefix(const Text& tableName, const Text& startAndPrefix, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  int32_t send_scannerOpenWithPrefix(const Text& tableName, const Text& startAndPrefix, const std::vector<Text> & columns, const std::map<Text, Text> & attributes);
  ScannerID recv_scannerOpenWithPrefix(const int32_t seqid);
  ScannerID scannerOpenTs(const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_scannerOpenTs(const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  ScannerID recv_scannerOpenTs(const int32_t seqid);
  ScannerID scannerOpenWithStopTs(const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  int32_t send_scannerOpenWithStopTs(const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const int64_t timestamp, const std::map<Text, Text> & attributes);
  ScannerID recv_scannerOpenWithStopTs(const int32_t seqid);
  void scannerGet(std::vector<TRowResult> & _return, const ScannerID id);
  int32_t send_scannerGet(const ScannerID id);
  void recv_scannerGet(std::vector<TRowResult> & _return, const int32_t seqid);
  void scannerGetList(std::vector<TRowResult> & _return, const ScannerID id, const int32_t nbRows);
  int32_t send_scannerGetList(const ScannerID id, const int32_t nbRows);
  void recv_scannerGetList(std::vector<TRowResult> & _return, const int32_t seqid);
  void scannerClose(const ScannerID id);
  int32_t send_scannerClose(const ScannerID id);
  void recv_scannerClose(const int32_t seqid);
  void getRowOrBefore(std::vector<TCell> & _return, const Text& tableName, const Text& row, const Text& family);
  int32_t send_getRowOrBefore(const Text& tableName, const Text& row, const Text& family);
  void recv_getRowOrBefore(std::vector<TCell> & _return, const int32_t seqid);
  void getRegionInfo(TRegionInfo& _return, const Text& row);
  int32_t send_getRegionInfo(const Text& row);
  void recv_getRegionInfo(TRegionInfo& _return, const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
